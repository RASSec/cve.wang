...
(function () {
    ...
    function initButtons() {
        ...
        dialog.onok = function () {
            ...
            if(list) {
                ...
                //触发一个编辑框自带的命令，该方法会触发addListener，用于图片单独上传面板
                editor.fireEvent('cleardoc', list);
            }
        };
    }
    ...
    RemoteImage.prototype = {
        ...
        initEvents: function () {
            ...
            var proportionInit = parseInt($G("width").value) / parseInt($G("height").value);
            locker.setAttribute('data-proportion', proportionInit);
    ...
    UploadImage.prototype = {
        ...
        initUploader: function () {
            ...
            uploader.on('uploadBeforeSend', function (file, data, header) {
                ...
                data['isWaterWark'] = document.getElementById('isWater').value;
                data['uploadSource'] = document.getElementById('uploadSource').value;
