<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/Default.Master" AutoEventWireup="true" CodeBehind="userloophole.aspx.cs" Inherits="Maticsoft.Web.Account.userloophole" %>
...
<asp:Content ID="Content4" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="content" style="margin-top: 20px;">
        <div style="width: 1024px; margin: 0 auto;">
            <div style="color: #002E8C; margin-left: 5px;margin-bottom:10px;"><font><b style="font-size: 24px;"><%=netname %>的漏洞列表</b></font></div>
                        ...
                        <asp:Repeater ID="rptNewSubmit" runat="server">
                            <ItemTemplate>
                                <tr>
                                    ...
                                    <td>
                                        <a href="javascript:void(0);" title="<%#GetUserNetName(Eval("netname").ToString()) %>"><%#GetUserNetName(Eval("netname").ToString()) %></a>										</a>
                                    </td>
                                </tr>
                            </ItemTemplate>
                        </asp:Repeater>
