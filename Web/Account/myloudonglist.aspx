<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/Default.Master" AutoEventWireup="true" CodeBehind="myloudonglist.aspx.cs" Inherits="Maticsoft.Web.Account.myloudonglist" %>
...
<asp:Content ID="Content4" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="content" style="margin-top: 20px;">
        <div style="width: 1024px; margin: 0 auto;">
            <div style="color: #002E8C; margin-left: 5px;margin-bottom:10px;"><font><b style="font-size: 24px;">我的漏洞列表</b></font></div>
