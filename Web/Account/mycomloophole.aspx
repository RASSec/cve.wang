<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/Default.Master" AutoEventWireup="true" CodeBehind="mycomloophole.aspx.cs" Inherits="Maticsoft.Web.Account.mycomloophole" %>
...
<asp:Content ID="Content4" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="content" style="margin-top: 20px;">
        <div style="width: 1024px; margin: 0 auto;">
            <div style="color: #002E8C; margin-left: 5px;margin-bottom:10px;"><font><b style="font-size: 24px;"><%=comname %>-厂商漏洞列表(<%=count %>)</b></font></div>
